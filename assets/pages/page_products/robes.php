    ...
    <div class="site_produit">
     ...
     <!-- en tête page nouveauté -->
        <div class="barCategorie">
            ...
            <a href="../page_products/robes.php"> <p class="barText2">robes</p> </a>
        </div>
        <p class="TitleNouveauté">Robes</p>
        ...
        <div class="filtreGlobal">
            <div class="filtreNouvauté">
                ...
                <div class="choixFiltre">
                    <p>robes de la semaine</p>
                    <p>(654)</p>
                    <p>robes de la saison</p>
                    <p>(323)</p>
            ...
            <?php
                $recupArticle = $pdo->query('SELECT * FROM produits WHERE types = (SELECT id FROM clothes WHERE types ="Robes")');
