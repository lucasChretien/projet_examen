    ...
    <div class="site_produit">
            ...
            <!-- navBar categorie -->
                <div class="categorie_global">
                    <div class="categorie">
                        ...
                        <a href="../page_products/hauts.php"> <p>hauts</p> </a>
     ...
     <!-- en tête page nouveauté -->
        <div class="barCategorie">
            ...
            <a href="../page_products/nouvaute.php"> <p class="barText1">nouveautés /</p> </a>
            <a href="../page_products/veste.php"> <p class="barText2">Vestes et manteaux</p> </a>
        </div>
        <p class="TitleNouveauté">Vestes et manteaux</p>
        ...
        <div class="filtreGlobal">
            <div class="filtreNouvauté">
                ...
                <div class="choixFiltre">
                    <p>Vestes et manteaux< de la semaine</p>
                    <p>(654)</p>
                    <p>Vestes et manteaux< de la saison</p>
                    <p>(323)</p>
                    <p>top ventes Vestes et manteaux<</p>
                    <p>(32)</p>
                </div>
                <!-- border séparateur -->
            ...
            <?php
                $recupArticle = $pdo->query('SELECT * FROM produits WHERE types = (SELECT id FROM clothes WHERE types ="Vestes_manteaux")');
