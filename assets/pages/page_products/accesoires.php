...
<body>
    ...
    <div class="site_produit">
     ...
     <!-- en tête page nouveauté -->
        ...
        <p class="TitleNouveauté">accesoires</p>
        ...
        <div class="filtreGlobal">
            <div class="filtreNouvauté">
                ...
                <div class="choixFiltre">
                    <p>accesoires de la semaine</p>
                    <p>(654)</p>
                    <p>accesoires de la saison</p>
                    <p>(323)</p>
                    <p>top vente accésoires</p>
                    <p>(90)</p>
                </div>
                <!-- border séparateur -->
            ...
            <?php
                $recupArticle = $pdo->query('SELECT * FROM produits WHERE types = (SELECT id FROM clothes WHERE types ="accesoires")');
