    ...
    <div class="site_produit">
     ...
     <!-- en tête page nouveauté -->
        <div class="barCategorie">
            ...
            <a href="./nouvaute.php"> <p class="barText2">nouveautés</p> </a>
        </div>
        <p class="TitleNouveauté">Nouveautés</p>
        ...
        <div class="filtreGlobal">
            <div class="filtreNouvauté">
                ...
                <div class="choixFiltre">
                    ...
                    <p>(654)</p>
                    <p>nouveautés de la saison</p>
                    <p>(323)</p>
                    <p>nouveautés pantalons</p>
                    <p>(32)</p>
                    <p>nouveautés robes </p>
                    <p>(21)</p>
                    <p>nouveautés hauts</p>
                    <p>(4)</p>
                    <p>nouveautés accésoires</p>
                    <p>(90)</p>
                </div>
                <!-- border séparateur -->
            ...
            <?php
                $recupArticle = $pdo->query('SELECT * FROM produits WHERE types = (SELECT id FROM clothes WHERE types ="nouveauté")');
