...
<body>
    ...
    <div class="site_produit">
     ...
     <!-- en tête page nouveauté -->
        ...
        <p class="TitleNouveauté">pantalons</p>
        ...
        <div class="filtreGlobal">
            <div class="filtreNouvauté">
                ...
                <div class="choixFiltre">
                    <p>pantalons de la semaine</p>
                    <p>(654)</p>
                    <p>pantalons de la saison</p>
                    <p>(323)</p>
                    <p>top vente pantalons</p>
                    <p>(90)</p>
                </div>
                <!-- border séparateur -->
            ...
            <?php
                $recupArticle = $pdo->query('SELECT * FROM produits WHERE types = (SELECT id FROM clothes WHERE types ="pantalons")');
