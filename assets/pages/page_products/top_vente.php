    ...
    <div class="site_produit">
     ...
     <!-- en tête page nouveauté -->
        <div class="barCategorie">
            ...
            <a href="../page_products/top_vente.php"> <p class="barText2">top Ventes</p> </a>
        </div>
        <p class="TitleNouveauté">Top Ventes</p>
        ...
        <div class="filtreGlobal">
            <div class="filtreNouvauté">
                ...
                <div class="choixFiltre">
                    <p>top ventes de la semaine</p>
                    <p>(654)</p>
                    <p>top ventes de la saison</p>
                    <p>(323)</p>
                    <p>top ventes pantalons</p>
                    <p>(32)</p>
                    <p>top ventes robes </p>
                    <p>(21)</p>
                    <p>top ventes hauts</p>
                    <p>(4)</p>
                    <p>top ventes accésoires</p>
                    <p>(90)</p>
                </div>
                <!-- border séparateur -->
            ...
            <?php
                $recupArticle = $pdo->query('SELECT * FROM produits WHERE types = (SELECT id FROM clothes WHERE types ="top ventes")');
