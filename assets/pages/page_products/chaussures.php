    ...
    <div class="site_produit">
     ...
     <!-- en tête page nouveauté -->
        <div class="barCategorie">
            ...
            <a href="../page_products/chaussures.php"> <p class="barText2">chaussures</p> </a>
        </div>
        <p class="TitleNouveauté">Chaussures</p>
        ...
        <div class="filtreGlobal">
            <div class="filtreNouvauté">
                ...
                <div class="choixFiltre">
                    <p>chaussures de la semaine</p>
                    <p>(654)</p>
                    <p>chaussures de la saison</p>
                    <p>(323)</p>
                    <p>top vente chaussures</p>
                    <p>(90)</p>
                </div>
                <!-- border séparateur -->
            ...
            <?php
                $recupArticle = $pdo->query('SELECT * FROM produits WHERE types = (SELECT id FROM clothes WHERE types ="Chaussure")');
